package br.ufmg.watchdogs.server.config.security;

import br.ufmg.watchdogs.server.filter.TokenAuthenticationFilter;
import br.ufmg.watchdogs.server.service.AuthenticationService;
