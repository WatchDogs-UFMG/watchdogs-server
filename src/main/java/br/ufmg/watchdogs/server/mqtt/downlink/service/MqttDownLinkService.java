...
public interface MqttDownLinkService {
    ...
    void publish(MqttDownLinkMessageImpl message, MqttDownLinkTopicImpl mqttDownLinkTopic, String spotID);

    default void log(MqttDownLinkMessageImpl message, String topic) {
